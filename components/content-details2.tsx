  ...
  const guideSteps = [
    {
      tab: "overview",
      message:
        "콘텐츠 개요 탭에서는 콘텐츠에 대한 소개와 특징들을 확인할 수 있습니다.",
    },
    {
      tab: "objectives",
      message:
        "학습 목표 탭에서는 학습 목표와 학습 주제, 기르고자 하는 역량 등을 확인할 수 있습니다.",
    },
    {
      tab: "guide",
      message:
        "교사 가이드 탭에서는 수업 지도안, 교과서, 활동지, PPT 자료 등을 다운 받으실 수 있습니다.",
    },
    {
      tab: "evaluation",
      message:
        "평가 자료 탭에서는 수행평가, 단원평가, 퀴즈 평가지와 답안을 다운 받으실 수 있습니다.",
    },
  ];
                ...
                >
                  ...
                  >
                    ...
                    <TabsContent value="guide" className="mt-0 h-full">
                      <h2 className="text-xl font-bold m-4 ml-1">
                        교사 가이드
                      </h2>
                      <div>
